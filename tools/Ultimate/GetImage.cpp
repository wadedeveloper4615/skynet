...
BOOL CGetImage::OnInitDialog() {
  ...
  m_volumes = (VOLUMES *) calloc(MAX_VOLUMES * sizeof(VOLUMES), 1);
...
int CGetImage::GetDrives(VOLUMES *volumes, const int max_count) {
...
void CGetImage::FillDrives(VOLUMES *volumes, const int count) {
  CString cs;
